...
// Begin JS library code
  ...
  var _emscripten_current_thread_is_audio_worklet = () => typeof AudioWorkletGlobalScope !== 'undefined';
...
var ASM_CONSTS = {
  94381: () => { return currentFrame; },  
 94406: ($0, $1) => { const ptr = $0; const len = $1; const str = UTF8ToString(ptr, len); console.log("[DEBUG] " + str); }
};
